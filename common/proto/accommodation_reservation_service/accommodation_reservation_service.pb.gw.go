...
func request_AccommodationReservationService_GetAllAcceptedReservationsForUser_0(ctx context.Context, marshaler runtime.Marshaler, client AccommodationReservationServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq GetAllAcceptedReservationsForUserRequest
	var metadata runtime.ServerMetadata
...
func RegisterAccommodationReservationServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server AccommodationReservationServiceServer) error {
	...
	mux.Handle("GET", pattern_AccommodationReservationService_GetAllAcceptedReservationsForUser_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/accommodation_reservation_service.AccommodationReservationService/GetAllAcceptedReservationsForUser", runtime.WithHTTPPathPattern("/reservations/getAllAcceptedForUser/{userId}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
func RegisterAccommodationReservationServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client AccommodationReservationServiceClient) error {
	...
	mux.Handle("GET", pattern_AccommodationReservationService_GetAllAcceptedReservationsForUser_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/accommodation_reservation_service.AccommodationReservationService/GetAllAcceptedReservationsForUser", runtime.WithHTTPPathPattern("/reservations/getAllAcceptedForUser/{userId}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	...
	pattern_AccommodationReservationService_GetAllAcceptedReservationsForUser_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2}, []string{"reservations", "getAllAcceptedForUser", "userId"}, ""))
)
